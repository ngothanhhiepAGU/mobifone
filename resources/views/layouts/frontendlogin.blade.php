...
<head>
    ...
    <meta name="author" content="Mobifone">
    <meta name="keywords" content="mobifone, dịch vụ di động, 4G, 5G, internet, viễn thông">
    <meta name="description" content="Mobifone - Nhà mạng viễn thông hàng đầu Việt Nam, cung cấp dịch vụ 4G, 5G, data, thoại và nhiều tiện ích khác.">
...
@include('partials.frontend.footer')
    ...
    <script>
      const swiper = new Swiper(".main-swiper", {
        loop: true,
        autoplay: {
          delay: 3000, // đổi slide sau mỗi 3 giây
          disableOnInteraction: false, // không tắt autoplay khi người dùng bấm nút
        },
        navigation: {
